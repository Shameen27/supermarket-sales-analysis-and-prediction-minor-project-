...
df = pd.read_excel("data/sales_replaced.xlsx",engine='openpyxl')
...
future_forcast = pd.read_excel("data/future_work.xlsx",engine='openpyxl')
future_forcast['Date'] = pd.to_datetime(future_forcast['Date']).dt.date
furniture_forcast=pd.read_excel("data/furniture_work.xlsx",engine='openpyxl')
office_forcast=pd.read_excel("data/office_work.xlsx",engine='openpyxl')
technology_forcast=pd.read_excel("data/technology_work.xlsx",engine='openpyxl')
#df = pd.DataFrame()
#df['Ship ']
# app = dash.Dash(
...
sale_total = pd.read_excel("data/sales_replaced.xlsx",engine='openpyxl')
sale_total.head()
